...
public class Empleado implements Serializable {
    ...
    @JoinColumn(name = "idPuestos", referencedColumnName = "id")
    @ManyToOne(optional = false)
    private Puestos idPuestos;
    ...
    public Empleado(Integer id, String nombre, String apellidoPaterno, String telefono, Character sexo, String direccion, String colonia, String ciudad, int cp, String apellidoMaterno) {
        this.id = id;
        this.nombre = nombre;
    ...
    public Puestos getIdPuestos() {
        return idPuestos;
    }

    public void setIdPuestos(Puestos idPuestos) {
